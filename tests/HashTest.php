...
class HashTest extends TestCase
{
    ...
    public function testMap()
    {
        ...
        $this->assertEquals(
            array_values(array_map($callback, $multiple)),
            $collection->map($callback)->values()
        );
    ...
    /*public function testRandom()
    {
        ...
        $this->assertTrue(in_array($random1->values(), array_values($multiple)));
        $this->assertTrue(in_array($multiple, $random2->toArray()));
    }*/
